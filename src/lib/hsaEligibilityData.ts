...
export const hsaEligibilityItems: HSAEligibilityItem[] = [
  ...
  },
  {
    ...
    category: CATEGORIES.MEDICAL_EQUIPMENT,
    status: 'eligible',
    description: 'Blood glucose monitors (CGM), test strips, lancets, and diabetic supplies. As of 2025, continuous glucose monitors (CGMs) for individuals diagnosed with diabetes are classified as preventive care under Notice 2024-75, meaning an HDHP may cover them before the deductible is met.',
    irsReference: 'Pub 502 - Medical Supplies; Notice 2024-75',
    keywords: ['glucose monitor', 'CGM', 'continuous glucose monitor', 'test strips', 'diabetes supplies'],
  },
  {
  ...
  },
  {
    ...
    category: CATEGORIES.PRESCRIPTION_DRUGS,
    status: 'eligible',
    description: 'Prescription birth control pills, patches, IUDs, and other contraceptives. As of 2025, over-the-counter (OTC) oral contraceptives and emergency contraceptives no longer require a prescription to be HSA-eligible — they qualify as preventive care under Notice 2024-75.',
    irsReference: 'Pub 502 - Birth Control Pills; Notice 2024-75',
    keywords: ['contraceptives', 'IUD', 'birth control pills', 'OTC contraceptives', 'emergency contraceptives', 'Plan B'],
  },
  {
    id: 'male-condoms',
    name: 'Condoms',
    category: CATEGORIES.PRESCRIPTION_DRUGS,
    status: 'eligible',
    description: 'Male condoms are HSA-eligible as qualified medical expenses under §213(d) per Notice 2024-71 (effective 2025). They also qualify as preventive care for HDHP purposes per Notice 2024-75, meaning an HDHP may cover them before the deductible is met.',

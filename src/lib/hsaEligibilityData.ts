...
export const hsaEligibilityItems: HSAEligibilityItem[] = [
  // Medical Services
  {
    ...
    status: "eligible",
    description:
      "Office visits to primary care physicians, specialists, and medical consultations.",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Surgical procedures performed by licensed medical professionals for medical necessity.",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "X-rays, MRIs, CT scans, ultrasounds, and other diagnostic imaging.",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Physical therapy prescribed by a physician for medical treatment.",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Occupational therapy prescribed for medical treatment or rehabilitation.",
    irsReference: "Pub 502 - Medical Services",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Generally not eligible unless medically necessary (e.g., reconstructive surgery after accident or disease).",
    conditions:
      "Only eligible if medically necessary to correct deformity from congenital abnormality, accident, or disease.",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "OTC medications are eligible only with a prescription from your doctor.",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Generally not eligible unless prescribed by a doctor for a specific medical condition.",
    conditions:
      "Eligible only with prescription for treating a diagnosed medical condition.",
    irsReference: "Pub 502 - Medicines",
    requiresLMN: true,
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Dental fillings, crowns, bridges, and other restorative work.",
    irsReference: "Pub 502 - Dental Treatment",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Generally not eligible unless prescribed for a medical condition.",
    conditions:
      "Eligible only if prescribed by a doctor for a specific medical condition.",
    irsReference: "Pub 502 - Eyeglasses",
    requiresLMN: true,
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Blood glucose monitors (CGM), test strips, lancets, and diabetic supplies. As of 2025, continuous glucose monitors (CGMs) for individuals diagnosed with diabetes are classified as preventive care under Notice 2024-75, meaning an HDHP may cover them before the deductible is met.",
    irsReference: "Pub 502 - Medical Supplies; Notice 2024-75",
    keywords: [
      "glucose monitor",
      "CGM",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Eligible when medically necessary and prescribed by a doctor.",
    conditions:
      "Requires prescription for medical condition (e.g., varicose veins, lymphedema).",
    irsReference: "Pub 502 - Medical Equipment",
    requiresLMN: true,
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Basic first aid supplies including bandages, antiseptics, and medical tape.",
  ...
  // Mental Health Services
  {
    ...
    status: "eligible",
    description:
      "Mental health counseling and therapy sessions with licensed professionals.",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Inpatient and outpatient treatment for drug or alcohol addiction.",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Therapeutic massage is eligible when prescribed by a doctor for a specific medical condition.",
    conditions:
      "Requires prescription from a licensed healthcare provider for medical treatment.",
    irsReference: "Pub 502 - Medical Services",
    requiresLMN: true,
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Cost of buying, training, and maintaining a service animal for medical purposes.",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Home improvements for medical care (e.g., wheelchair ramps, widening doorways).",
    conditions:
      "Only the amount that exceeds the increase in home value is eligible.",
  ...
  // Insurance Premiums
  {
    ...
    status: "conditional",
    description:
      "Generally not eligible with HSA funds, except in specific circumstances.",
    conditions:
      "Eligible only for COBRA, unemployment, Medicare, or long-term care insurance.",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Vaccines and immunizations recommended by healthcare providers.",
    irsReference: "Pub 502 - Medical Care",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Preventive cancer screenings including mammograms, colonoscopies, and other tests.",
    irsReference: "Pub 502 - Medical Care",
  ...
  // Common Ineligible Items
  {
    ...
    description:
      "Generally not eligible unless prescribed by a doctor for a specific medical condition.",
    conditions:
      "Eligible only with prescription for treating a diagnosed disease (e.g., obesity, heart disease).",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Weight loss programs are eligible only if prescribed by a doctor for a specific disease.",
    conditions:
      "Eligible when prescribed for treatment of obesity or other specific disease.",
  ...
  },
  {
    ...
    status: "conditional",
    description:
      "Eligible when prescribed for treatment of a specific disease.",
    conditions:
      "Requires prescription for treating diagnosed medical condition (e.g., diabetes, heart disease).",
    irsReference: "Pub 502 - Medical Services",
    requiresLMN: true,
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Prescription birth control pills, patches, IUDs, and other contraceptives. As of 2025, over-the-counter (OTC) oral contraceptives and emergency contraceptives no longer require a prescription to be HSA-eligible — they qualify as preventive care under Notice 2024-75.",
    irsReference: "Pub 502 - Birth Control Pills; Notice 2024-75",
    keywords: [
      "contraceptives",
      "IUD",
      "birth control pills",
  ...
  },
  {
    ...
    status: "eligible",
    description:
      "Male condoms are HSA-eligible as qualified medical expenses under §213(d) per Notice 2024-71 (effective 2025). They also qualify as preventive care for HDHP purposes per Notice 2024-75, meaning an HDHP may cover them before the deductible is met.",
    irsReference: "Notice 2024-71; Notice 2024-75",
    keywords: ["condoms", "contraception", "preventive care"],
  },
  {
  ...
  },
  {
    ...
    status: "not-eligible",
    description:
      "Not eligible because marijuana is a controlled substance under federal law.",
    irsReference: "Pub 502",
...
export function searchEligibilityItems(query: string): HSAEligibilityItem[] {
  ...
  return hsaEligibilityItems.filter((item) => {
    ...
    return (
      matchesName || matchesCategory || matchesDescription || matchesKeywords
    );
  });
}

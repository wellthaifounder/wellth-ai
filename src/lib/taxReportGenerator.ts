...
export const generateTaxPackageReport = async (
  ...
  const complianceSections = [
    {
      ...
      content:
        "IRS Publication 502 defines qualified medical expenses. This report includes only expenses you marked as HSA-eligible in the Wellth app. You are responsible for ensuring these expenses meet IRS requirements.",
    },
    {
  ...
  doc.text(
    `Generated by Wellth on ${format(new Date(), "MMMM d, yyyy")}`,
    margin,
    yPosition,
  );
  doc.text(

    ...
    <Card className="p-6">
      <div className="space-y-6">
            ...
            <div className="flex-1">
              ...
              {suggestion.invoice && (
                <p className="text-xs text-muted-foreground mt-1">
                  Bill: {suggestion.invoice.vendor} • $
            ...
            >
              ...
              <span>
                ...
                <span className="text-muted-foreground block text-xs mt-0.5">
                  I'll automatically categorize similar transactions in the
                  future
                </span>
              </span>
            </label>
        ...
        <div className="grid grid-cols-2 gap-3">
          {suggestion.type === "link_to_invoice" ||
          suggestion.type === "mark_medical" ? (
            <>
              <Button
        ...
        <div className="flex items-center justify-center gap-4 pt-2 text-xs text-muted-foreground">
          <span>
            <kbd className="px-1.5 py-0.5 bg-muted rounded">M</kbd> Medical
          </span>
          <span>
            <kbd className="px-1.5 py-0.5 bg-muted rounded">N</kbd> Not Medical
          </span>
          <span>

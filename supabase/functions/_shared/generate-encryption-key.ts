...
console.log(
  "- Store this key in a secure secrets manager (1Password, AWS Secrets Manager, etc.)",
);
console.log(
  "- Back up this key - if lost, all encrypted tokens become unusable",
);
console.log("- Never commit this key to version control");
console.log(
  "- Use the same key across all environments that share the same database",
);
console.log("");
console.log("=".repeat(80));

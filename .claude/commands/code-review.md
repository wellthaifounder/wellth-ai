...
- Are there dead code artifacts: no-op variables, backwards-compat shims, or removal comments?
...
- **Don't soften real issues.** Downplaying bugs that will reach production is dishonest.
